<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Men_Rings.aspx.cs" Inherits="tambeshop.Men_Rings" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <link href="Css2.1/Men_Rings.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <div class="container-fluid">
    <div class="row">
    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Banners/M_Ring_Banner.jpg" Height="200px" Width="100%" /></div>
    <div class="row">
    ...
    <div class="col-md-10 col-sm-10 col-lg-10">
         ...
         <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" 
            ...
            <ItemTemplate>
                <br />
                <br />
                <div class="card" style=" height:550px; width:270px;">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"  
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="101" Name="subcatid" 
