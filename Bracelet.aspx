<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Bracelet.aspx.cs" Inherits="tambeshop.Bracelet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <link href="Css2.1/Bracelet.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="container-fluid">
    <div class="row">
    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Banners/M_Bracelet_Banner.jpg" Height="200px" Width="100%" />
</div>
<div class="row">
    ...
    <div class="col-md-10 col-sm-10">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"  
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="103" Name="subcatid" 
