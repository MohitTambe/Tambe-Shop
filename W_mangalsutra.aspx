<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="W_mangalsutra.aspx.cs" Inherits="tambeshop.W_mangalsutra" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <link href="Css2.1/W_mangalsutra.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Banners/w_mangalsutra.png" Height="200px" Width="100%" /></div>
        <div class="row">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"  
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="208" Name="subcatid" 
