<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Men_pendant.aspx.cs" Inherits="tambeshop.Men_pendant" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <link href="Css2.1/Men_pendant.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
    <div class="row">
    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Banners/M_Pendant_Banner.jpg" Height="200px" Width="100%" />
</div>
<div class="row">
    ...
    <div class="col-md-10 col-sm-10">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"  
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="104" Name="subcatid" 
