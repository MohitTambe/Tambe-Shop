<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="W_chian.aspx.cs" Inherits="tambeshop.W_chian" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <link href="Css2.1/W_Chain.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">

        <div class="row">
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Banners/w_chain.png" Height="200px" Width="100%" />
    </div>
        ...
        <div class="row">
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="204" Name="subcatid" 
