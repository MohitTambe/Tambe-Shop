<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="Bangles.aspx.cs" Inherits="tambeshop.Bangles" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <link href="Css2.1/W_Bangles.css" rel="stylesheet" type="text/css" />
</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Banners/w_bangle.png" Height="200px" Width="100%" /></div>
        <div class="row">
            ...
            <div class="col-md-10 col-sm-10">
                <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" DataSourceID="SqlDataSource1" RepeatColumns="4" DataKeyField="productid" 
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <asp:Button ID="Button1" runat="server" Text="View Detail" 
                                CssClass="btn btn-secondary detail" CommandName="viewdetail"  
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"  
            ...
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="203" Name="subcatid" 
